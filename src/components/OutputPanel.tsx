...
function OutputPanel({ cssCode }: OutputPanelProps) {
  ...
  return (
    <section className="h-full min-h-96 w-full shrink-0 overflow-hidden rounded-2xl border border-slate-300 bg-white text-wrap shadow-[0_16px_40px_rgba(15,23,42,0.12)] md:w-90 lg:w-105 xl:w-115.75">
